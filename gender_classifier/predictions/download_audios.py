...
def main(in_file, aud_col_name, dest_pth_mp3):
    filedf = pd.read_excel(in_file)
    aud_links = filedf[aud_col_name].fillna('').tolist()
...
if __name__ == "__main__":
    ...
    aud_col_name = args.aud_col_name
    ...
    main(in_file, aud_col_name, dest_pth_mp3)
