...
def main(in_file, dest_pth_mp3):
    ...
    aud_links = filedf['audio_url'].fillna('').tolist()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, help="File containing the clean data",
        default="latest_acc_rej_data.xlsx", required=True)
